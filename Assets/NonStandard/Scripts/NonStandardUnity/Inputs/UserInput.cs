...
namespace NonStandard.Inputs {
	...
	public class UserInput : MonoBehaviour {
		...
		private void OnEnable() { KeyInput.Enable(KeyBinds); AxisInput.OnEnable(AxisBinds); }
		private void OnDisable() { KeyInput.Disable(KeyBinds); AxisInput.OnDisable(AxisBinds); }
