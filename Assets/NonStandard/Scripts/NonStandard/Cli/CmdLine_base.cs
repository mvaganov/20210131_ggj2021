...
#if UNITY_2017_1_OR_NEWER
		public void HandleLog(string logString, string stackTrace = "", UnityEngine.LogType type = UnityEngine.LogType.Log) {
			HandleLog(logString, stackTrace, (LogType)type);
		}
#endif
		public enum LogType { Assert, Error, Exception, Log, Warning }
