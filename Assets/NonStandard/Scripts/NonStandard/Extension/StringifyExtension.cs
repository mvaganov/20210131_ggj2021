...
public static class StringifyExtension {
	...
	/// <returns></returns>
	public static string Stringify(this object obj, bool pretty = true, bool showType = true, bool showNulls = false, bool showBoundary = true, int depth = 0, List<object> rStack = null, Func<object, object, object, string> filter = null, Func<Type,string> howToMarkStrongType = null) {
