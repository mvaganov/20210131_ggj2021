...
public class DialogViewer : MonoBehaviour {
	...
	public void SetDialog(string name, UiPolicy uiPolicy) {
		...
		if (dialog == null) { Commander.Tokenizer.AddError("missing dialog \"" + name + "\""); }
	...
	public void SetDialog(Dialog dialog, UiPolicy uiPolicy) {
		...
		if (dialog == null) { Commander.Tokenizer.AddError("missing dialog");  return; }
	...
	public void ContinueDialog(string name) { DialogManager.ActiveDialog = this; SetDialog(name, UiPolicy.Continue); }
